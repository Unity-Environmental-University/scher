...
export class WasmSociety {
     ...
     * @returns {string}
     */
    qualityObjectsFrom(event, quality, as_of) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(event, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ret = wasm.wasmsociety_qualityObjectsFrom(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    qualitySubjectsOnto(row, quality, as_of) {
        let deferred3_0;
        let deferred3_1;
        try {
            ...
            const ptr1 = passStringToWasm0(quality, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_qualitySubjectsOnto(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    reachesSet(from, quality, as_of) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(quality, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_reachesSet(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    rowOf(slug) {
        ...
        try {
            const ptr0 = passStringToWasm0(slug, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_rowOf(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
