/* @ts-self-types="./scher_core_wasm.d.ts" */
...
export class WasmSociety {
     ...
     * @returns {string}
     */
    bucketsOf(event, as_of) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(event, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_bucketsOf(this.__wbg_ptr, ptr0, len0, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    countedOf(holder, key, as_of) {
        ...
        try {
            ...
            const ret = wasm.wasmsociety_countedOf(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    has(slug) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsociety_has(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    isOccluded(target, as_of) {
        const ptr0 = passStringToWasm0(target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsociety_isOccluded(this.__wbg_ptr, ptr0, len0, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
        return ret !== 0;
    }
    /**
     ...
     * @returns {string}
     */
    membersOf(event, as_of) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(event, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_membersOf(this.__wbg_ptr, ptr0, len0, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    constructor(rows_json) {
        const ptr0 = passStringToWasm0(rows_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsociety_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        WasmSocietyFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @param {string} holder
     * @param {number | null | undefined} as_of
     * @param {boolean} keep_empty
     * @returns {string}
     */
    readCounted(holder, as_of, keep_empty) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(holder, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsociety_readCounted(this.__wbg_ptr, ptr0, len0, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of, keep_empty);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    sectionOf(holder, key, as_of) {
        const ptr0 = passStringToWasm0(holder, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsociety_sectionOf(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
        let v3;
        if (ret[0] !== 0) {
     ...
     */
    size() {
        const ret = wasm.wasmsociety_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    valueOf(holder, key, as_of) {
        const ptr0 = passStringToWasm0(holder, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsociety_valueOf(this.__wbg_ptr, ptr0, len0, ptr1, len1, !isLikeNone(as_of), isLikeNone(as_of) ? 0 : as_of);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./scher_core_wasm_bg.js": import0,
    };
}

const WasmSocietyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmsociety_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('scher_core_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
